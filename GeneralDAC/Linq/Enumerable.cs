...
namespace GeneralDAC.Linq
{
    public static class Enumerable
    {
        /// <summary>
        /// make an enumerable collection to be converted to a list.
        /// </summary>
        /// <param name="source">enumberable source.</param>
